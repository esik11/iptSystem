...
<input type="hidden" name= "customerId"value = "<?=$customer ['data']['id']; ?>" >
                    ...
                    <div class="col-md-6">
                        <label>Status (Unchecked = Visble, Checked = Hidden)</label>
                        <br>
                        <input type="checkbox" name="status" value = "<?=$customer ['data']['status'] == true ? 'checked': ''; ?>" value="1" style="width:30px;height:30px;">
                    </div>
