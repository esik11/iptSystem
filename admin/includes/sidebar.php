                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#"
                             data-bs-toggle="collapse"
                              data-bs-target="#collapseITEMCATEGORY" aria-expanded="false" aria-controls="collapseITEMCATEGORY">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                ITEM CATEGORIES
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseITEMCATEGORY" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="create-categories.php">CREATE ITEM CATEGORY</a>
                                    <a class="nav-link" href="categories.php">VIEW ITEM CATEGORIES</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#"
                             data-bs-toggle="collapse"
                            ...
                            <div class="collapse" id="collapsePRODUCTS" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="create-products.php">ADD A PRODUCT</a>
                            ...
                            <div class="collapse" id="collapseAdmins" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="create-admin.php">ADD ADMINS</a>
